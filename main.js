...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6289513081052@s.whatsapp.net`, {text: 'Successfully connected by\n\n*💌 • Name BOT:* ' + global.namebot + '\n*🎐 • Name OWNER:* ' + global.nameown + '\n*📞 • Nomor OWNER:* https://wa.me/' + global.nomorown })
}
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = '👏🏻DADAH KAKAK @user\n_ KENAPA KELUAR KAKAK_'
