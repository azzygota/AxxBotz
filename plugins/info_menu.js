...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args }) => {
 ...
 let waofc = `@${'0'.split('@')[0]}`
 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}
 let creator = `@${'6289513081052'.split('@')[0]}`
 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}
 let creator2 = `@${'6289513081052'.split('@')[0]}`
 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}
 let 𝙰𝚍𝚛𝚒𝚊𝚗 𝚇 𝙽𝚊𝚒𝚜𝚊 = `@${'6285860928363'.split('@')[0]}`
